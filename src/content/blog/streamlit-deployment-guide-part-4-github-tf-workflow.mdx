...
Refer to [Azure Federated Identity Credentials for Terraform: A GitHub Actions Guide](https://waynegoosen.com/post/fed-creds-tf-github-actions/) to enable authenticating the workflow with Azure.
